        ...
        <div class="row clearfix">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="body">
                        <form id="basic-form" method="post" novalidate action="{{ route('post_user.add') }}">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <label class="fancy-radio">
                                    <input type="radio" name="role" value="{{ $role->id }}" required data-parsley-errors-container="#error-radio">
                            ...
                            <div class="form-group">
                                ...
                                <br/>
                                <select id="group_leader" name="group_leader" class="multiselect multiselect-custom form-control w-100" data-parsley-required data-parsley-trigger-after-failure="change" data-parsley-errors-container="#error-multiselect">
                            ...
                            <div class="form-group">
                                ...
                                <br />
                                <label class="fancy-radio">
                                    <input type="radio" checked name="role" value="4" required data-parsley-errors-container="#error-radio">
                                    <span><i></i>USER</span>
                                </label>
                                <p id="error-radio"></p>
                            </div>
